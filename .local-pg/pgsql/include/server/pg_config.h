...
#define CONFIGURE_ARGS " '--prefix' '/opt/postgresql' '--enable-integer-datetimes' '--enable-option-checking=fatal' '--enable-thread-safety' '--with-gssapi' '--without-icu' '--without-ldap' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-openssl' '--with-pgport=5432' '--with-python' '--with-readline' '--with-system-tzdata=/usr/share/zoneinfo' '--with-uuid=ossp' '--with-zstd' 'LLVM_CONFIG=/usr/lib/llvm-16/bin/llvm-config' 'CLANG=clang-16'"
...
#define PG_VERSION_STR "PostgreSQL 16.10 on x86_64-pc-linux-gnu, compiled by gcc (Debian 12.2.0-14+deb12u1) 12.2.0, 64-bit"
